 ...
 */
typedef NS_ENUM(NSUInteger, GTMTransitionDirection) {
    /**
     The fore view controller is being presented.
     */
    GTMTransitionDirectionForward,

    /**
     The fore view controller is being dismissed.
     */
    GTMTransitionDirectionBackward,
...
@protocol GTMTransitionContext <NSObject>
 ...
 */
@property(nonatomic, readonly) GTMTransitionDirection direction;
 ...
 */
- (void)composeWithTransition:(nonnull id<GTMTransition>)transition;
