...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GTMotionTransitioning.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'GTMotionTransitioning/Classes/**/*'
  
  # s.resource_bundles = {
  #   'GTMotionTransitioning' => ['GTMotionTransitioning/Assets/*.png']
  # }
